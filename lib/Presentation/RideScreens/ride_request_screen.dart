...
import 'package:connection/Presentation/PassengerRideScreens/PassengerRideScreen1.dart';
...
class _RideRequestScreenState extends State<RideRequestScreen> {
  ...
  submitRideRequest() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse(ApiPath.submitRideRequest));
