...
import 'package:connection/Presentation/PassengerRideScreens/passenger_request_screen.dart';
...
class _PassengerListScreenState extends State<PassengerListScreen> {
  ...
  passengerList() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse(ApiPath.getPassengersList));
                            ...
                            children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: const BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage('assets/images/passengerRideimage.png',),
                                              fit: BoxFit.fill
                                          )
                                      ),
                                      child:  Padding(
                                        ...
                                        child: Row(
                                          ...
                                          const   Text('Create new ride',style: TextStyle(
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 10,),
                                  Text('OR',style: TextStyle(color: CustomColors.grayColor),),
                                  Padding(
                                            ...
                                            child: Column(
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Image.asset('assets/images/travlinguser.png',
                                                      height: 80,
                                                      width: 80,
                                                    ),
                                                    Padding(
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                       ...
                                                       Icon(Icons.person, color: Colors.orange, size: 16,),
                                                          Text(rideListData!.data![index].noOfPerson.toString(),
                                                            style: TextStyle(fontSize: 11),),
                                                        ],
                                                      ),
                                                      const SizedBox(width: 10,),
                                                      Row(
                                                        children: [
                                                          ...
                                                          Text(rideListData!.data![index].dateAdded.toString(),
                                                            style: TextStyle(fontSize: 11),),
                                                          Container(
                                                            height: 10,
                                                      ...
                                                      Row(
                                                        children: [
                                                         ImageIcon(
                                                           ...
                                                           size: 16,
                                                           color: rideListData!.data![index].bookingType.toString() == "urgent"?
                                                            Colors.red :
                                                           rideListData!.data![index].bookingType.toString() == "flexible"?
                                                           Colors.green :
                                                           Color(0xFF010759),
                                                         ),
                                                          const SizedBox(width: 5,),
                                                          Text(rideListData!.data![index].bookingType.toString(),
                                                            style: TextStyle(fontSize: 11),),
                                                        ],
                                                      ),
                                                      // Row(
